pipeline {
  ...
  parameters {
    choice(name: 'OLD_VERSION', choices: ['2.42.0', '2.41.0', '2.40.0', '2.39.0', '2.38.0', '2.37.0', '2.36.0', '2.35.0', '2.34.0', '2.33.0', '2.32.0', '2.31.0', '2.30.0', '2.29.0', '2.28.0', '2.27.0', '2.26.0', '2.25.0', '2.24.0'], description: 'Old Version')
    choice(name: 'NEW_VERSION', choices: ['2.43.0', '2.42.0', '2.41.0', '2.40.0', '2.39.0', '2.38.0', '2.37.0', '2.36.0', '2.35.0', '2.34.0', '2.33.0', '2.32.0', '2.31.0', '2.30.0', '2.29.0', '2.28.0', '2.27.0', '2.26.0', '2.25.0', '2.24.0'], description: 'New Version')
  }
  ...
  stages {
    ...
    stage('Copy Xtext DEV Build') {
      steps {
        script {
          copyArtifacts(
            projectName: 'xtext-monorepo-full-deploy-nightly',

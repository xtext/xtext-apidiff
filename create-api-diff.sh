...
then
   ...
   -metadataRepository http://download.eclipse.org/modeling/tmf/xtext/updates/releases/2.18.0/,http://download.eclipse.org/releases/photon,http://download.eclipse.org/lsp4j/updates/releases/ \
   -artifactRepository http://download.eclipse.org/modeling/tmf/xtext/updates/releases/2.18.0/,http://download.eclipse.org/releases/photon,http://download.eclipse.org/lsp4j/updates/releases/ \
